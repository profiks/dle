...
function dle_activation ( code ){
	...
	document.getElementById( 'hack_result_info' ).innerHTML = '{$lang['nl_sinfo']}';
	if (code == 'key') {
	...
	if(!is_writable(ENGINE_DIR . '/data/config.php')) {
		...
		echo "<div id=\"dle-activation\">
            ...
            <div class=\"dleOfficialActivation\" style=\"margin-left: 15px; display: block;\">
                $lang[trial_info]<br /><br /><b>$lang[trial_key]</b>
                <span style=\"padding-left:7px;\">
                    <input class=\"edit bk\" type=\"text\" size=\"45\" name=\"sitekey\" id=\"sitekey\">
                    <input class=\"btn btn-success btn-mini\" type=\"button\" onClick=\"dle_activation( 'key' ); return false;\" value=\"$lang[trial_act]\">
                </span>
                <div id=\"result_info\" style=\"color:red;\"><br />
                    <span class=\"navigation\">{$lang['key_format']} <b>XXXXX-XXXXX-XXXXX-XXXXX-XXXXX</b></span>
                </div>
            </div>
